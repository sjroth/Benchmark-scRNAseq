...
workflow {
  ...
  // 1k PBMC data.
  get_exp_human_1k(download_prereq_data.out.cellranger_reference, download_prereq_data.out.fastq_dir_1k, 'cell', "${outbase}/1k")
  ...
  // 5k PBMC data.
  get_exp_human_5k(download_prereq_data.out.cellranger_reference, download_prereq_data.out.fastq_dir_5k, 'cell', "${outbase}/5k")
  ...
  get_exp_human_nuclear(download_prereq_data.out.cellranger_reference, download_prereq_data.out.fastq_dir_nuc, 'nuclear', "${outbase}/geo")
  ...
  get_exp_mouse(download_prereq_data.out.cellranger_reference_mouse, download_prereq_data.out.fastq_dir_mouse_nuc, 'nuclear', "${outbase}/mouse")
}

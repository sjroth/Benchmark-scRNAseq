...
params.outbase = "s3://fulcrumtx-users/sroth/Benchmark-scRNAseq"
...
workflow {
  ...
  // 1k PBMC data.
  get_exp_human_1k(download_prereq_data.out.cellranger_reference, download_prereq_data.out.fastq_dir_1k, 'cell', "${params.outbase}/1k")
  run_kb_count_1k(kallisto_reference.out.kallisto_index, kallisto_reference.out.transcripts_to_genes, download_prereq_data.out.read1_files_1k, download_prereq_data.out.read2_files_1k, "${params.outbase}/1k")
  ...
  get_exp_mouse(download_prereq_data.out.cellranger_reference_mouse, download_prereq_data.out.fastq_dir_mouse_nuc, 'nuclear', "${params.outbase}/mouse")
}

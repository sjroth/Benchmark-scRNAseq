...
workflow {
  ...
  get_exp_mouse(download_prereq_data.out.cellranger_reference_mouse, build_indices_mm10.out.star_idx_full, build_indices_mm10.out.star_idx_sparse, build_indices_mm10.out.salmon_cdna_index, build_indices_mm10.out.salmon_splici_index, build_indices_mm10.out.salmon_sparse_index, download_prereq_data.out.fastq_dir_mouse_nuc, download_prereq_data.out.read1_files_mouse_nuc, download_prereq_data.out.read2_files_mouse_nuc, 'nuclear', download_prereq_data.out.barcodes_v2, 'v2', build_indices_mm10.out.salmon_cdna_t2g, build_indices_mm10.out.salmon_splici_t2g, "mouse")
}

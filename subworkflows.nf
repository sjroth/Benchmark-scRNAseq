...
include { transcriptome; transcript_to_gene; splici; remvoe_t2g_col; generate_salmon_index; salmon_sel_mapping; salmon_sketch_mapping ; generate_permit_list; collate_rad_file_and_quant } from './run-alevin'
